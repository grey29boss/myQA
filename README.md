...
<p>Перевод автоматом, но всё равно понятно. Пример основан на работе стирки белья)))</p>
	<ul
		<li><a href="#section1">Преимущества вариантов использования</a></li>
		<li><a href="#section2">Элементы варианта использования</a></li>
		<li><a href="#section3">Как написать сценарий использования</a></li>
		<li><a href="#section4">Примеры использования</a></li>
</ul>
...
<h2 id="section1">Преимущества вариантов использования</h2>
